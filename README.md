...
- Python 3.10+
- Node.js 18+（推荐同时安装 Bun）
- PowerShell 5.1+ 或 PowerShell 7+
- LightRAG 依赖的 LLM/Embedding 服务（如 OpenAI 兼容服务、Ollama 等）

完整依赖说明见 [docs/REQUIREMENTS.md](docs/REQUIREMENTS.md)。
...
# 3. 安装前端依赖（没有 Bun 时可使用 npm install）
cd lightrag_webui
...
| 文档 | 说明 |
|------|------|
| [docs/REQUIREMENTS.md](docs/REQUIREMENTS.md) | 统一依赖、安装方式、PowerShell 启停说明 |
